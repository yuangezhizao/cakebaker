```
POST https://api.m.jd.com/client.action?functionId=cakebaker_pk_getHomeData HTTP/1.1
Host: api.m.jd.com
...
functionId=cakebaker_pk_getHomeData&body={}&client=wh5&clientVersion=1.0.0

HTTP/1.1 200
Date: Wed, 17 Jun 2020 14:22:19 GMT
Content-Type: application/json;charset=utf-8
Connection: keep-alive
Access-Control-Allow-Origin: https://bunearth.m.jd.com
Access-Control-Allow-Credentials: true
Access-Control-Expose-Headers: X-API-Request-Id
X-API-Request-Id: 179929017-10124-1592403739380
X-API-Wl-Message: 0
Server: jfe
...

{
    ...
    "data": {
        ...
        "result": {
            ...
            "groupAward": "12.00",
            "groupInfo": {
                "groupJoinInviteId": "VlU-EZopB3UqYfdw9i_WMit6a6lu9j7qEKY5Hd0wgHdEEVzueHe90w",
                "groupLevel": 99,
                "groupLoginInviteId": "UFUwFogpDGYAXuhq4z7pHvbnAE8wS1JDC3z8lrXptv8-1faILRbKdF4",
                "groupName": "害怕",
                "groupNum": 5,
                "memberList": [
                    {
            ...
            "groupPkInfo": {
                "bombInfo": {
                    "status": 4,
                    "totalActReduceLevel": 0
                },
                "decision": 0,
                "groupAssistInviteId": "XUkkFpUhDG0TdNd1-Sv4IQUQzVCUNWytXrTWdtlA7rzBSLx_CO3OfB0NKChONA",
                "matchDetail": {
                    "current": 0,
                    "lowerAward": "4",
                    "matchId": 3,
